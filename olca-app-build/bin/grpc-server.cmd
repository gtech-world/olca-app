...
rem This script will start a headless gRPC server for a database in the aicpLCA
...
rem aicpLCA comes with an embedded JRE that we use
...
rem can give more RAM via the Xmx parameter etc. It will use the default aicpLCA
rem workspace in ~/aicpLCA-data-1.4 and connect to the database provided by the
