...
# This script will start a headless gRPC server for a database in the aicpLCA
...
# another server setup by changing the start command below. See also the aicpLCA
# IPC documentation.
...
# can give more RAM via the Xmx parameter etc. It will use the default aicpLCA
